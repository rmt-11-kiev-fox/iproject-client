<template>
  <div class="register-container">
    ...
    <i class="fas fa-times icon-close" @click="popUpModal(false)"></i>
    <form @submit.prevent="editProductHandler">
...
export default {
  ...
  methods: {
    ...
    popUpModal(val) {
      this.$store.commit('PRODUCT_EDIT_MODAL_HANDLER')
    },
    editProductHandler() {
      const {
        dueDate,
      ...
      this.$store.dispatch('editProductHandler', {
        data: obj,
